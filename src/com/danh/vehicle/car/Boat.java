...
public class Boat extends Vehicle implements DealWithSpeed, HaveEngine {
    ...
    public Boat(UUID id, String manufacturer, String model, BigDecimal price, String color, CarType type) {
