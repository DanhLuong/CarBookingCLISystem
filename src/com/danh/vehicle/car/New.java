...
public class New extends Vehicle implements DealWithSpeed, HaveEngine {
    ...
    public New(UUID id, String manufacturer, String model, BigDecimal price, String color, CarType type) {
