...
public class AirPlane extends Vehicle implements DealWithSpeed, HaveEngine {
    ...
    public AirPlane(UUID id, String manufacturer, String model, BigDecimal price, String color, CarType type) {
