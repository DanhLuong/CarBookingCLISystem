...
public class Car extends Vehicle implements DealWithSpeed, HaveEngine {
    ...
    public Car(UUID id, String manufacturer, String model, BigDecimal price, String color, CarType type) {
